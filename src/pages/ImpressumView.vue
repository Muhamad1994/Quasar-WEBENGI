<template>
  <article>
    ...
    <div class="Impressum">
      ...
      Vertreten durch: <br />Vorstand Fachschaft Wirtschaft <br />
      <h3>Kontakt</h3>
      Telefon: 0431-210 4914 <br />E-Mail: mail(at)fawi-fhkiel.de
      <br />Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV: <br />Vorstand
      Fachschaft Wirtschaft Sokratesplatz 2 24149 Kiel <br />
      <h4>Haftungsausschluss:</h4>
      <h3>Haftung für Inhalte</h3>
      <br />Die Inhalte unserer Seiten wurden mit größter Sorgfalt erstellt. Für
...
/* Optional: Hover-Effekte für Links */
article a:hover {
